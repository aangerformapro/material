...
// generate xlinks
export const ng_contact = new Xlink('ng-contact');
export const ng_dashboard = new Xlink('ng-dashboard');
...
export const ng_menu = new Xlink('ng-menu');
export const ng_reg = new Xlink('ng-reg');
