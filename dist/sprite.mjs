...
// generate xlinks
export const ng_equals = new Xlink('ng-equals');
export const ng_gold = new Xlink('ng-gold');
export const ng_heart = new Xlink('ng-heart');
export const ng_level = new Xlink('ng-level');
export const ng_minus = new Xlink('ng-minus');
export const ng_pause = new Xlink('ng-pause');
export const ng_play = new Xlink('ng-play');
export const ng_plus = new Xlink('ng-plus');
export const ng_skull = new Xlink('ng-skull');
export const ng_timer = new Xlink('ng-timer');
